...
const createAircraftIcon = (rotation: number = 0, isSelected: boolean = false, isMobile: boolean = false) => {
  try {
    ...
    const svg = `<svg width="${size}" height="${size}" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style="transform: rotate(${rotation}deg);">
      <path fill="${color}" d="M12 2 L11 10 L8 11 L8 13 L11 13.5 L11 20 L10 21 L12 20.5 L14 21 L13 20 L13 13.5 L16 13 L16 11 L13 10 Z"/>
    </svg>`;
...
export default function MapComponent({ aircraft, selectedAircraft, onSelectAircraft, selectedTrail, trailHistory }: MapComponentProps) {
  ...
  try {
    return (
      ...
      >
        <TileLayer
          attribution='&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors &copy; <a href="https://carto.com/attributions">CARTO</a> | Data: <a href="https://adsb.fi/">adsb.fi</a>'
